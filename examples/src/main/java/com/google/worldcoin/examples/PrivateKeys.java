 ...
 *
 * <a href="http://www.worldcoin.org/smf/index.php?topic=3638.0">http://www.worldcoin.org/smf/index.php?topic=3638
 * .0</a><p>
 *
...
public class PrivateKeys {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            // And take them!
            System.out.println("Claiming " + Utils.worldcoinValueToFriendlyString(wallet.getBalance()) + " coins");
