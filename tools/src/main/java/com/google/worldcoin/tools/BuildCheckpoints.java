...
public class BuildCheckpoints {
    public static void main(String[] args) throws Exception {
        ...
        final PeerAddress peerAddress = new PeerAddress(InetAddress.getByName("seednode1.worldcoinfoundation.org"));
        ...
        StoredBlock test = manager.getCheckpointBefore(1368671710);  // Just after block 4571
        checkState(test.getHeight() == 4560);
        checkState(test.getHeader().getHashAsString().equals("170491a7d67e06c82b257ecde9fa9d5e7ee61fcfb0682fae13eceef7c71142b8"));
    }
}
