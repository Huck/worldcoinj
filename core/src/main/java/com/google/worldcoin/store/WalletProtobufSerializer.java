...
public class WalletProtobufSerializer {
    ...
    public void readWallet(Protos.Wallet walletProto, Wallet wallet) throws UnreadableWalletException {
        ...
        if (walletProto.hasVersion()) {
            ...
            if (version == WorldcoinWalletVersion.PROTOBUF.getWalletVersionAsInt()) {
    ...
    private WalletTransaction connectTransactionOutputs(org.worldcoinj.wallet.Protos.Transaction txProto) throws UnreadableWalletException {
