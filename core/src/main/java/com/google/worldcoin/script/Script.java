 ...
 *
 * <p>Bitcoin transactions don't specify what they do directly. Instead <a href="https://en.worldcoin.it/wiki/Script">a
...
public class Script {
     ...
     * logic is defined by <a href="https://en.worldcoin.it/wiki/BIP_0016">BIP 16</a>.</p>
     *
    ...
    public void correctlySpends(Transaction txContainingThis, long scriptSigIndex, Script scriptPubKey,
        ...
        try {
            txContainingThis = new Transaction(txContainingThis.getParams(), txContainingThis.worldcoinSerialize());
