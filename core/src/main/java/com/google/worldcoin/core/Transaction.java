 ...
 * <a href="http://code.google.com/p/worldcoinj/wiki/WorkingWithTransactions">"Working with transactions"</a> in the
...
public class Transaction extends ChildMessage implements Serializable {
    ...
    public void clearInputs() {
        ...
        this.length = this.worldcoinSerialize().length;
    }
     ...
     * This is useful in certain types of <a href="http://en.worldcoin.it/wiki/Contracts">contracts</a>, such as
