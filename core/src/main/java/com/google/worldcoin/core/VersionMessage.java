...
public class VersionMessage extends Message {
     ...
     * users might look like "/BitCoinJ:0.4-SNAPSHOT/WorldcoinWallet:1.2/" where libraries come further to the left.<p>
     *
     ...
     * else. For example, calling <tt>appendToSubVer("WorldcoinWallet", "1.0", "Windows")</tt> will result in a subVer being
     * set of "/BitCoinJ:1.0/WorldcoinWallet:1.0(Windows)/. Therefore the / ( and ) characters are reserved in all these
     * components. If you don't want to add a comment (recommended), pass null.<p>
     *
     * See <a href="https://en.worldcoin.it/wiki/BIP_0014">BIP 14</a> for more information.
     *
