...
public class Utils {
    ...
    public static final String WORLDCOIN_SIGNED_MESSAGE_HEADER = "Worldcoin Signed Message:\n";
    ...
    public static BigInteger toNanoCoins(String coins) {
        ...
        if (bigint.compareTo(NetworkParameters.MAX_MONEY) > 0)
            throw new ArithmeticException("Amount larger than the total quantity of Worldcoins possible specified.");
        return bigint;
    }
