 ...
 * @author Jim Burton (enhancements for WorldcoinWallet)
...
public class WorldcoinURI {
     ...
     */
    public WorldcoinURI(String uri) throws WorldcoinURIParseException {
        this(null, uri);
    }
     ...
     *
     * @throws WorldcoinURIParseException If the input fails Bitcoin URI syntax and semantic checks.
     */
    public WorldcoinURI(@Nullable NetworkParameters params, String input) throws WorldcoinURIParseException {
        checkNotNull(input);
     ...
     */
    private void parseParameters(@Nullable NetworkParameters params, String addressToken, String[] nameValuePairTokens) throws WorldcoinURIParseException {
        ...
        for (String nameValuePairToken : nameValuePairTokens) {
            ...
            if (tokens.length != 2 || "".equals(tokens[0])) {
                throw new WorldcoinURIParseException("Malformed Bitcoin URI - cannot parse name value pair '" +
                        nameValuePairToken + "'");
            }
     ...
     */
    private void putWithValidation(String key, Object value) throws WorldcoinURIParseException {
        if (parameterMap.containsKey(key)) {
            throw new WorldcoinURIParseException(String.format("'%s' is duplicated, URI is invalid", key));
        } else {
     ...
     */
    public static String convertToWorldcoinURI(String address, @Nullable BigInteger amount, @Nullable String label,
