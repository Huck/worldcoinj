...
public class BlockChainTest {
    ...
    public void difficultyTransitions() throws Exception {
        ...
        b.setDifficultyTarget(0x201FFF2FL);
        b.solve();
    ...
    public void badDifficulty() throws Exception {
        ...
        bad.setNonce(1753022464);
        bad.setTime(1368504828 );
        ...
        try {
            ...
            //worldcoin:  fix this message later. disabled for now
    ...
    private static Block getBlock2() throws Exception {
        ...
        b2.setMerkleRoot(new Sha256Hash("12ff7b6218fdfdbb1f7efc9b81de901575fd181e019381e135f3e4496c86f6bf"));
        b2.setNonce(3265399808L);
        b2.setTime(1368504816L);
        b2.setPrevBlockHash(new Sha256Hash("1a48c2bf97e0df6d4f03cd5cb0896ef43b04987048fbeb5ab2dc013335e40731"));
        assertEquals("b439caa3baf7e8f6532783ef630ff18293f237da42d3cc8975620d3e3ca96bb3", b2.getHashAsString());
        b2.verifyHeader();
        return b2;
    }
    ...
    private static Block getBlock1() throws Exception {
        ...
        b1.setMerkleRoot(new Sha256Hash("0fc36e386282295512aa63d9f5047d9dc305c983394803474cfaa2f99d7e1bd0"));
        b1.setNonce(253823232);
        b1.setTime(1368504801);
        b1.setPrevBlockHash(new Sha256Hash("7231b064d3e620c55960abce2963ea19e1c3ffb6f5ff70e975114835a7024107"));
        assertEquals("1a48c2bf97e0df6d4f03cd5cb0896ef43b04987048fbeb5ab2dc013335e40731", b1.getHashAsString());
        b1.verifyHeader();
        return b1;
    }
    ...
    public void estimatedBlockTime() throws Exception {
        ...
        assertEquals(new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZ").parse("2017-03-02T18:18:27.000-0700"), d);
    }
