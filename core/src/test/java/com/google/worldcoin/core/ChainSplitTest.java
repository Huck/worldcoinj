...
public class ChainSplitTest {
    ...
    public void testForking1() throws Exception {
      /*  // Check that if the block chain forks, we end up using the right chain. Only tests inbound transactions
        ...
        assertEquals("100.00", Utils.worldcoinValueToFriendlyString(wallet.getBalance()));
        ...
        assertEquals("50.00", Utils.worldcoinValueToFriendlyString(wallet.getBalance()));
        ...
        assertEquals("200.00", Utils.worldcoinValueToFriendlyString(wallet.getBalance()));*/
    }
    ...
    private Block roundtrip(Block b2) throws ProtocolException {
        return new Block(unitTestParams, b2.worldcoinSerialize());
    }
    ...
    public void txConfidenceLevels() throws Exception {
        ...
        assertEquals("250.00", Utils.worldcoinValueToFriendlyString(wallet.getBalance()));
