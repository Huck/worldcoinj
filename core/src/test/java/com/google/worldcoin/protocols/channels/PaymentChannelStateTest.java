...
public class PaymentChannelStateTest extends TestWithWallet {
    ...
    public void basic() throws Exception {
        ...
        Transaction refund = new Transaction(params, clientState.getIncompleteRefundTransaction().worldcoinSerialize());
        ...
        Transaction multisigContract = new Transaction(params, clientState.getMultisigContract().worldcoinSerialize());
        ...
        final Transaction reserializedCloseTx = new Transaction(params, closeTx.worldcoinSerialize());
    ...
    public void checkBadData() throws Exception {
        ...
        byte[] refundTxBytes = clientState.getIncompleteRefundTransaction().worldcoinSerialize();
        ...
        byte[] multisigContractSerialized = clientState.getMultisigContract().worldcoinSerialize();
    ...
    public void doubleSpendContractTest() throws Exception {
        ...
        doubleSpendContract = new Transaction(params, doubleSpendContract.worldcoinSerialize());
